...
def test_close_event_cleans_up(sensor_plotter):
    ...
    assert sensor_plotter.sensor_worker is None, "Sensor worker was not cleared on close."
    ...
    assert sensor_plotter.modbus_client is None, "Modbus client was not cleared on close."
