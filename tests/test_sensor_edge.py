import pytest
from sensor import Sensor, SensorError, ADC_MAX, VOLTAGE_FULL_SCALE, POLL_INTERVAL_MS
...
def test_sensor_out_of_range(monkeypatch):
    ...
    expected_value = (expected_voltage / VOLTAGE_FULL_SCALE) * dummy_config[0]["scale"] * dummy_config[0]["calibration"]
